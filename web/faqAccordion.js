 ...
 *   /* Or use max-height for smooth animation: *\/
 *   .faq-answer { max-height: 0; overflow: hidden; transition: max-height 0.3s ease; }
 *   .faq-item.active .faq-answer { max-height: 500px; }
 *
 * Options:
 *   itemSelector     — selector for each accordion item (default: '.faq-item')
 *   triggerSelector  — selector for the clickable button (default: '.faq-question')
 *   activeClass      — class applied to the open item (default: 'active')
 *
...
module.exports = { initFaqAccordion };
