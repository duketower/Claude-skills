 ...
 * Uses a scroll listener to track position; designed for single-page layouts
 * with sections that have `id` attributes.
 *
 * Targets: `section[id]` elements and `.nav-links a[href^="#"]` links.
 *
